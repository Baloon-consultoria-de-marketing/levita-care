...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-[rgb(var(--color-hero-bg))] scroll-smooth">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl items-center px-6 py-16">
        <section className="w-full max-w-xl rounded-3xl border border-[rgb(var(--color-white)/0.6)] bg-[rgb(var(--color-white)/0.65)] p-8 shadow-[0_20px_60px_rgb(var(--color-hero-shadow)/0.25)] backdrop-blur-md sm:p-10">
          <h1 className="text-5xl max-w-120 font-normal leading-tight text-[rgb(var(--color-hero-heading))] ">Recuperação Confortável e Segura: Alugue Poltronas Elétricas para Pós-Operatório.</h1>

          <p className="mt-5 leading-relaxed text-[rgb(var(--color-hero-body))] max-w-96 text-[17px] font-extralight">Tenha uma recuperação tranquila, com conforto e autonomia garantidos.</p>
